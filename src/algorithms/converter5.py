...
class Converter5(object):
    ...
    def find_cut(self, vertex_list,group):
        ...
        for community in community_cut:
            '''
            print("----------------------")
            print(community_cut[community]/(len(G.edges())-community_cut[community]))
            print(community_cut[community] / len(G.edges()))
            print(community_cut[community])
            #print(len(G.edges))
            print(community_nodenum[community])
            print(vertex_num-community_nodenum[community])
            '''
            if (community_nodenum[community] * (vertex_num - community_nodenum[community]) - community_cut[community]) / \
